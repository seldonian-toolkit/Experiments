...
constraints = ['equalized_odds','equalized_odds_stephen']

if __name__ == "__main__":

	start = time.time()
	savename = os.path.join(plot_dir,'equalized_odds_comparison.png')
	...
	for ii,constraint in enumerate(constraints):
		...
		ax_sr.plot(X,mean_sr,color='g',linestyle='--',label='Quasi-Seldonian Classification')
