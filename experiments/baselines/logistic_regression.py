...
class BinaryLogisticRegressionBaseline(BinaryLogisticRegressionModel,SupervisedExperimentBaseline):
    def __init__(self,):
        """Implements a logistic regression classifier for binary classification"""
        BinaryLogisticRegressionModel.__init__(self) # inherits parent's predict() method.
