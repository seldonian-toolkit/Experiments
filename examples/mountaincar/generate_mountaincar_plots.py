...
if __name__ == "__main__":
	...
	n_workers = 7
	verbose=True
	results_dir = f'../../results/mountaincar_2022Sep19_debug'
	os.makedirs(results_dir,exist_ok=True)
	plot_savename = os.path.join(results_dir,f'mountaincar_{n_trials}trials.png')
	n_episodes_for_eval = 500
	# Load spec
	specfile = f'../../../engine-repo-dev/examples/n_step_mountaincar/spec.pkl'
	...
	hyperparameter_and_setting_dict["env"] = "n_step_mountaincar"
	hyperparameter_and_setting_dict["agent"] = "Parameterized_non_learning_softmax_agent"
	hyperparameter_and_setting_dict["num_episodes"] = 500
