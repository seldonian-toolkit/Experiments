...
from lie_detection.generate_experiment_plots import lie_detection_example_all_safety_frac
from loans.generate_experiment_plots import loans_example_all_safety_frac
from gpa_science_classification.generate_experiment_plots import gpa_example_all_safety_frac
...
if __name__ == "__main__":
	...
	for example in examples_to_run:
		...
		if example == 'lie_detection':	
			lie_detection_example_all_safety_frac(
				spec_rootdir=spec_rootdir,
				results_base_dir=results_example_basedir,
			    constraints=example_setup_dict[example]['constraints'],
			    n_trials=example_setup_dict[example]['n_trials'],
